        ...
        handlers : {
            ...
            deck : {
                ...
                cardMouseOver : function(event) {
                    ...
                    var cardHint        = cards.getDeckHandler(deck).createHintCard(cardType);
                ...
                selectorWheel : function(deck, dropPosX, dropPosY, cell) {
                    ...
                    var cardIcons           = cards.getDeckHandler(deck).createCardIcons();
                    ...
                    var clickedFunc         = function (event) {
                        fields.handlers.deck.cardClicked(event, dropPosX, dropPosY, cell);
                    };
                    ...
                    for(var i = 0; i < cardIcons.length; i++) {
                        ...
                        cardIcons[i]
                            .off(   'mouseover')    .on('mouseover',    fields.handlers.deck.cardMouseOver)
                            .off(   'mouseout')     .on('mouseout',     fields.handlers.deck.cardMouseOut)
