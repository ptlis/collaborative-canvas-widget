...
/*  Time (in seconds) to delay propegation of card data changes */
        changeDelay     : 0.25,
        ...
        setLocalStorageUIUpdateFunc : function(uiUpdateFunction) {
            ...
            if(canvasStorage.method === 'localStorage') {
                ...
                window.setTimeout(function() {
                    ...
                    standardPropagate();    // TODO: Better way of calling (this is passed as a param in another func)
                        ...
                        var getFunc = function(prefix, instanceId) {
                            ...
                            if(itemData.prev !== null || itemData.next !== null || itemData.id === canvasStorage.list.cache.getFirstItemId(prefix)) {
                                ...
                                if(prefix === 'card') {
                                    ...
                                    var cardExtraFields = cards.getDeckHandler(itemData.deck).getExtraFields(itemData.cardtype);
            ...
            remove : function(prefix, remItemData) {
                ...
                if(canvasStorage.method === 'wave' || canvasStorage.method === 'localStorage') {
                    ...
                    if(prefix === 'card') {
                        ...
                        var cardExtraFields = cards.getDeckHandler(deck).getExtraFields(cardType);
