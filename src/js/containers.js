            ...
            .on('click', function() {
                ...
                if(containerArr.length < 1) {
                    ...
                    dialog.fadeOut(250, function() {
                        ...
                        decks.createSelectionDialog(true);
                    });
                }
            });
    },
            ...
            if(typeof(dd.instanceid) === 'undefined') {
                ...
                if(typeof(deck) !== 'undefined') {
                    ...
                    $(bgElem).fadeIn(250, function() {
                        fields.handlers.deck.selectorWheel(deck, dropPosX, dropPosY, cell);
                    });
