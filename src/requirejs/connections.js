...
define(
    ...
    function($, require, canvasStorage, util, raphael) {
        ...
        /*  Raphael SVG wrapper */
        connections.raphaelCanvas = null;
        ...
        connections.addEvents = function(connectionLabelElem) {
        ...
        connections.removeEvents = function(connectionLabelElem) {
...
/* Model */
        connections.model.getFields = function() {
            return {
                from:       '',
                to:         '',
                label:      '',
        ...
        connections.model.add = function(event, connectionId, fromCardId, toCardId, labelString) {
            var extraFields     = {};
        ...
        connections.model.remove = function(event, connectionId) {
        ...
        connections.model.removeForCard = function(event, cardId) {
        ...
        connections.model.toFront = function(event, connectionId) {
        ...
        connections.model.getForCard = function(cardId) {
        ...
        connections.model.exists = function(card1Id, card2Id) {
            var exists              = false;
...
/* View */
    ...
    connections.view.add = function(event, connectionData) {
        ...
        connections.view.editLabel = function(event, connectionId) {
            connections.handlers.connectionEditStart(connectionId);
        };


        connections.view.remove = function(event, connectionData) {
        ...
        connections.view.removeAll = function() {
        ...
        connections.view.move = function(event, fromCardId, toCardId, fromCardDimensions, toCardDimensions) {
            var cards            = require('cards');
            ...
            connections.cachedConnections[fromCardId][toCardId].line.attr(
                    {   'path':               pathData.path,
                        'stroke-width':       width});
        ...
        connections.view.moveForCard = function(event, cardId) {
        ...
        connections.view.updateAllPaths = function(event) {
            var cards            = require('cards');
...
/* Handlers */
        ...
        connections.handlers.stopCursorScroll = function() {
        ...
        connections.handlers.updateCursorScroll = function() {
            var canvasElem      = $('#canvas');
        ...
        connections.handlers.updateDynamicPath = function(event) {
            var cards            = require('cards');
        ...
        connections.handlers.connectionStart = function(action, cardElem, connectionId) {
        ...
        connections.handlers.connectionCreateStart = function(cardElem) {
            connections.handlers.connectionStart('create', cardElem);
        };


        connections.handlers.connectionEditStart = function(connectionId) {
        ...
        connections.handlers.connectionFinish = function() {
            var cards            = require('cards');
